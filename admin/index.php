	...
	<body>
		<nav class = "navbar bg-success navbar-fixed-top">
			<div class = "container-fluid">
				...
				<a href="../index.php"><img src = "images/isulogo.png" class="mt-4" width = "50px" height = "50px"/></a>
					<p class = "navbar-text pull-right">ISU Ilagan Library</p>
				</div>
				<ul class = "nav navbar-nav navbar-right">
					<li>
								<li><a class="text-success" href = "../index.php"><i class = "glyphicon glyphicon-user"></i> Attendance login</a></li>
