	...
	<body class = "alert-primary">
		<nav class = "navbar bg-success navbar-fixed-top ">
			<div class = "container-fluid">
				...
				<ul class = "nav navbar-nav navbar-right">
					<li>
							<li><a class="text-success" href = "index1.php"><i class = "glyphicon glyphicon-user"></i> Faculty Login</a></li>
					</li>
					<li>
							<li><a class="text-success" href = "admin/index.php"><i class = "glyphicon glyphicon-user"></i> Admin Login</a></li>
					</li>
				</ul>
			</div>
		</nav>
												...
												if (mysqli_num_rows($course_result) > 0) {
													...
													<select required name="course" class="form-control">
														...
														while ($courseItem = mysqli_fetch_assoc($course_result)) {
															?>
															<option value="<?php echo $courseItem['course']; ?>"><?php echo $courseItem['course']; ?></option>
															<?php
														}
														?>
													</select>
		...
		<div class = "container-fluid">
			...
			<div class = "col-lg-4 well">
				<button class = "btn btn-success pull-right btn-sm col-lg-3" type = "button" href = "#" data-toggle = "modal" data-target = "#add_student">
